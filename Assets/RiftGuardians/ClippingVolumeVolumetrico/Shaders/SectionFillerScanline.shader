Shader "Custom/SectionFiller_Scanline"
{
    Properties
    {
        _FillColor("Fill Color", Color) = (0,1,1,0.2)
        _EdgeColor("Edge Glow", Color) = (0.4,1,1,1)
        _EdgePower("Edge Power", Range(0.1,10)) = 4

        _ScrollSpeed("Scan Speed", Float) = 2.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Frag(Varyings IN):SV_Target
            {
                ...
                float scan = sin(IN.posWS.y * 25 + _Time.y * _ScrollSpeed);
                ...
                return float4(col, t * _FillColor.a);
            }
            ENDHLSL
        }
    }
